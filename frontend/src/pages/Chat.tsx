    ...
    try {
      ...
      setMessages((prev) => [
        ...prev.filter((m) => m.id !== "loading"),
        {
          ...
          sender: "ai",
          text: data.reply || "I'm having trouble connecting to my medical database. Please try again later.",
        },
      ]);
    } catch (err) {
      setMessages((prev) => [
        ...prev.filter((m) => m.id !== "loading"),
        {
          id: Date.now().toString(),
          sender: "ai",
          text: "Sorry, I can't connect to the health assistant right now.",
        },
      ]);
    } finally {
      setIsLoading(false);
