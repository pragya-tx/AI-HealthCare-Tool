...
def update_vocab():
    with open(r"c:\CODING ONLY\THE BEST PROJECT EVER\Final\disease_symptom_matrix.csv", "r", encoding="utf-8") as f:
        reader = csv.reader(f)
        headers = next(reader)
    ...
    with open(r"c:\CODING ONLY\THE BEST PROJECT EVER\Final\symptom_ner\symptoms_vocab.json", "w", encoding="utf-8") as f:
